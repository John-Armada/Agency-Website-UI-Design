    ...
    return (
        <header className="bg-[#F5F7FA]">
            ...
            <div className="flex flex-row gap-[3.5] justify-center items-center">
                <button className="cursor-pointer flex justify-center items-center px-5 py-2.5 text-[#28CB8B] h-10">Login</button>
                <button className="cursor-pointer px-5 py-2.5 w-[120px] text-white bg-[#28CB8B] rounded-md text-center">Sign Up</button>
            </div>
        </div>
        </header>
