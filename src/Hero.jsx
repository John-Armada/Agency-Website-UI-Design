            ...
            <section className='flex flex-col justify-center items-center '>
                <div className='flex flex-row justify-center items-center gap-[104px] mx-36 my-24'>
                    <div className='flex flex-col justify-center'>
                        <h1 className='text-[64px] font-semibold text-base/[76px]'>Lessons and insights <span className='text-[#28CB8B] block'>from 8 years</span></h1>
                        <p className='mt-4 mb-8'>Where to grow your business as a photographer: site or social media?</p>
                        <button className='bg-[#28CB8B] px-8 py-3.5 w-32 rounded-sm text-white'>Register</button>
                    </div>
                    <div>
